...
function startGame() {
    ...
    if (maximumNumber > 10) {
        ...
        p.outerHTML = '<p class="red">The entered number must be larger than 10</p>';
    };
};
...
function guess() {
    ...
    if (yourGuess == targetNumber) {
        stage2.innerHTML = '<p class="blue">congratulations!You were successful</p>';
        return;
    ...
    if (remainingChances > 0) {
        ...
        stage2.innerHTML = '<p class="red">Unfortunately your opportunity ended!</p>';
    }
}